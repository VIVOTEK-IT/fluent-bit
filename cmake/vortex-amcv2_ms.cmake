...
#  cd build/
#  cmake .. -DCMAKE_TOOLCHAIN_FILE=../cmake/vortex-amcv2_ms.cmake -DCMAKE_INSTALL_PREFIX=./output
# 
# lbbacktrace use autoconf, need to set GNU_HOST or it will use wrong toolchain:
# export PATH=/opt/toolchains/amcv2x/linaro-aarch64-2020.09-gcc10.2-linux5.4/bin:$PATH
# cmake .. -DCMAKE_TOOLCHAIN_FILE=../cmake/vortex-amcv2_ms.cmake -DCMAKE_INSTALL_PREFIX=./output -DGNU_HOST=aarch64-linux -DSANITIZE_ADDRESS=On
